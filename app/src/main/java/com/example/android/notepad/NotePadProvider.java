...
public class NotePadProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (!values.containsKey(NotePad.Notes.COLUMN_NAME_TITLE)) {
            values.put(NotePad.Notes.COLUMN_NAME_TITLE, ""); // 默认空标题
        }
        ...
        long rowId = db.insert(NOTES_TABLE_NAME, NotePad.Notes.COLUMN_NAME_NOTE, values);
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case NOTE_ID:
                ...
                count = db.delete(NOTES_TABLE_NAME, NotePad.Notes._ID + "=" + noteId
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case NOTE_ID:
                String noteId = uri.getPathSegments().get(1);
                count = db.update(NOTES_TABLE_NAME, values, NotePad.Notes._ID + "=" + noteId
                        + (!TextUtils.isEmpty(where) ? " AND (" + where + ')' : ""), whereArgs);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
